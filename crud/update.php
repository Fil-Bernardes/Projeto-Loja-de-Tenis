...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $insert = mysqli_query($conexao, "UPDATE usuario SET nome = '$name', cpf = '$cpf', endereco = '$address', tipo = '$type' WHERE id =  $id");
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="form-outline mb-4">
            ...
            <input type="text" id="form3Example3" name="name" id="name" class="form-control form-control-lg"placeholder="Nome" value="<?= isset($dadoUsuario['nome']) ? $dadoUsuario['nome'] : '' ?>" required />            
          </div>

          <!-- Password input -->
          <div class="form-outline mb-3">
            <label class="form-label" for="form3Example3">CPF</label>
            <input type="text" id="form3Example3" name="cpf" id="cpf" class="form-control form-control-lg"placeholder="CPF" value="<?= isset($dadoUsuario['cpf']) ? $dadoUsuario['cpf'] : '' ?>" required/>   
          </div>

          <div class="form-outline mb-4">
            <label class="form-label" for="form3Example3">Endereço</label>
            <input type="text" id="form3Example3" name="address" id="address" class="form-control form-control-lg"placeholder="Endereço" value="<?= isset($dadoUsuario['endereco']) ? $dadoUsuario['endereco'] : '' ?>" required/>            
          </div>

          <input type="hidden" id="id" name="id" value="<?= isset($dadoUsuario['id']) ? $dadoUsuario['id'] : '' ?>">
          <div class="form-outline mb-4">
